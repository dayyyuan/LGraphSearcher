 ...
 */
public class GSpanEdgeFeatureSelection implements Comparable {
	public int nodeA;
	public int nodeB;
	public int labelA;
	public int labelB, edgeLabel;
	public GSpanEdgeFeatureSelection prev = null; // the previous and next edge
													// in the DFSCode
	public GSpanEdgeFeatureSelection next = null;

	public GSpanEdgeFeatureSelection bPrev = null;
	public GSpanEdgeFeatureSelection bNext = null;

	public int attachedNode; // attachedNode == -1 then in the root

	// attachedNode == nodeCount;
	 ...
	 * @param labelB
	 */
	public GSpanEdgeFeatureSelection(int labelA, int edgeLabel, int labelB,
			int attachedNode) {
		this.nodeA = 0;
		this.nodeB = 1;
	 ...
	 * @param labelB
	 */
	public GSpanEdgeFeatureSelection(int nodeA, int nodeB, int labelA,
			int edgeLabel, int labelB, int attachedNode) {
		this.nodeA = nodeA;
		this.nodeB = nodeB;
		this.labelA = labelA;
		this.labelB = labelB;
	...
	public int compareTo(Object o) {
		GSpanEdgeFeatureSelection other = (GSpanEdgeFeatureSelection) o;

		if (this.attachedNode < other.attachedNode)
			return -1;
		else if (this.attachedNode > other.attachedNode)
			return 1;
